            ...
            if(filter_txt === 'year'){
                ...
                rpc.query({
                    ...
                    for(var i=0;i<res['purchase_based_on_hours'].length;i++){
                        hrs_pay_data.push({'hours': res['purchase_based_on_hours'][i].date_order_hour[0] + '-' + res['purchase_based_on_hours'][i].date_order_hour[1], 'price': res['purchase_based_on_hours'][i].price_total, 'quantity': res['purchase_based_on_hours'][i].quantity});
                    }
                    var hour = ''
        ...
        header_data : function(company_id){
            ...
            rpc.query({
                ...
                if(res){
                    ...
                    self.$el.find('.total-orders').text(res['total_purchase'] || '0')
                    self.$el.find('.total-sales').text(res['total_sale'] || '0')
                    self.$el.find('.product-sold').text(res['product_sold'] || '0')
